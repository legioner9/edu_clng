...
fn_13390_7193() {
	...
	local pth_to_gig_sh_fn_13390_7193="${HOME}/edu_clng/.d/.crl/edu_clang_c.crl.d/edu_clang_c.crl.crd/.fri.14/gig_dr.sh"
...
#DATE :: Вс 14 июн 2026 02:28:34 +07
#SGN :: . ${HOME}/aer_foe/.d/.frp/make_014.frp/frp2dr.sh ${HOME}/edu_clng/.d/.crl/edu_clang_c.crl.d/edu_clang_c.crl.crd/.fri.14
