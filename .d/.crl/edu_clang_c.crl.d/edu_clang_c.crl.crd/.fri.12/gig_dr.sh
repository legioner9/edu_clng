...
fn_13390_7193() {
	...
	local pth_to_gig_sh_fn_13390_7193="${HOME}/edu_clng/.d/.crl/edu_clang_c.crl.d/edu_clang_c.crl.crd/.fri.12/gig_dr.sh"
    ...
    :
        ...
        doing :: create dir cpy _.d with dr_pth=\$1 [[usually rel_pth/00N]]
            ...
            and ins_file_tst=\$3 [[!!unix style pth]] use l_02_fs2f() in start_this_tst.sh generated in dr_nm/_.d/.tst/start_this_tst.sh
            use lfoe_gig_sh()
            \$4 :: mv main.c -> \$4
	...
	if [[ ! -f ${arg2_13390_7193} ]]; then

		echo -e "${ECHO_RET1}in file://$fl_pth_fn_13390_7193 , line=${LINENO} [[that insert file]] ARG2_NOTFILE::${arg2_13390_7193}, return 1${NRM}" >&2
		return 1

	fi

	if [[ -z "${arg3_13390_7193}" ]]; then
		echo -e "${ECHO_RET1}in file://$fl_pth_fn_13390_7193 , line=${LINENO}  ARG2_ISEMPTY, return 1${NRM}" >&2
		return 1
	fi

	if [[ ! -f ${arg3_13390_7193} ]]; then

		echo -e "${ECHO_RET1}in file://$fl_pth_fn_13390_7193 , line=${LINENO} [[that insert file]] ARG2_NOTFILE::${arg3_13390_7193}, return 1${NRM}" >&2
		return 1
	...
	if [[ -n "${arg4_13390_7193}" ]]; then

		echo "main.c -> ${arg4_13390_7193} as arg3"
		mv ${result_dr}/_.d/main.c ${result_dr}/_.d/${arg4_13390_7193}

		# l_02_s2f :: reciver_string: $1 inserter_string: $2 [@ - empty string] in reciver_result_file: $3
		l_02_s2f "main.c" ${arg4_13390_7193} ${result_dr}/_.d/makefile
		# l_02_fs2f ins.f {{body}} rcv.f
		l_02_fs2f "${HOME}/edu_clng/.d/.osdn/.hnt/clang.body.hnt" {{hint}} ${result_dr}/_.d/${arg4_13390_7193}
	...
	l_02_fs2f "${arg2_13390_7193}" {{body}} ${result_dr}/start.sh
	...
	l_02_fs2f "${arg3_13390_7193}" {{body}} ${result_dr_d}/.tst/start_this_tst.sh
	#! end
...
#DATE :: Сб 13 июн 2026 10:27:24 +07
#SGN :: . ${HOME}/aer_foe/.d/.frp/make_012.frp/frp2dr.sh ${HOME}/edu_clng/.d/.crl/edu_clang_c.crl.d/edu_clang_c.crl.crd/.fri.12
