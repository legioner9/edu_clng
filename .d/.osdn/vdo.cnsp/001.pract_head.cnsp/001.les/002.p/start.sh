...
fn_23002_8592(){
    ...
    local fl_pth_fn_23002_8592="${HOME}/edu_clng/.d/.osdn/vdo.cnsp/001.pract_head.cnsp/001.les/002.p/start.sh"
    local dr_pth_fn_23002_8592=$(dirname ${HOME}/edu_clng/.d/.osdn/vdo.cnsp/001.pract_head.cnsp/001.les/002.p/start.sh)
    local fl_nm_fn_23002_8592=$(basename ${HOME}/edu_clng/.d/.osdn/vdo.cnsp/001.pract_head.cnsp/001.les/002.p/start.sh)
    local rnd=23002_8592
